        ...
        <footer className={styles.footer} id="footer">  
            <div>
                <ul>
                    ...
                    <li>KVK: 91341167</li>
                    <li>BTW / TVA: NL004883756B73</li>
                </ul>

                <ul>
                    <li><h2>Halal Delight</h2></li>
                    <li><Link target="_blank" href="https://halaldelight.eu/">Global</Link></li>
                ...
                <ul>
                    ...
                    <li><Link target="_blank" href="https://instagram.com/halaldelight.be"><Image src={instagramIco} alt="Logo of Instagram"/> Instagram</Link></li>
